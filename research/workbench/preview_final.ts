...
// same minimal PNG encoder + RGB565 decode as before
...
const patched = readFileSync("/tmp/claude-0/-home-user-zelda-arabic-magic-a76daea1/30195602-0f97-5db6-98d0-4ccab372886b/scratchpad/zelda2_mag-arabic-logo-v2.gar.lzs");
...
console.log("files:", files.map(f=>`${f.typeName}/${f.fileName}(${f.data.length}b)`));
...
const outPath = "/tmp/claude-0/-home-user-zelda-arabic-magic-a76daea1/30195602-0f97-5db6-98d0-4ccab372886b/scratchpad/final_preview_title00.png";
