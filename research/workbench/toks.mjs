// ../../../tmp/claude-0/-home-user-zelda-arabic-magic-a76daea1/30195602-0f97-5db6-98d0-4ccab372886b/scratchpad/toks.ts
...
function gtaIvRawUnitsToString(units) {
...
var style = sorted.filter(([t]) => /^~[a-z]~$/.test(t));
