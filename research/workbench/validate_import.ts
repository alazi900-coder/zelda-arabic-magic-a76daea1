...
import { extractPlatEntries } from "./src/lib/nds/plat-editor-bridge";
import { fromBreakTokens } from "./src/lib/nds/plat-break-tokens";
import { encodePlatMessage } from "./src/lib/nds/plat-msg-codec";
import { reshapeArabic } from "./src/lib/arabic-shaping";
...
writeFileSync(`${SCR}/validation_report.json`, JSON.stringify({ missingKey, breakDiff, tagDiff, encodeFail, tooLong, latin, trailingSpace, untranslated }, null, 2));
