// ../../../tmp/claude-0/-home-user-zelda-arabic-magic-a76daea1/30195602-0f97-5db6-98d0-4ccab372886b/scratchpad/verify.ts
...
// src/lib/nds/plat-categories.ts
var PLATINUM_CATEGORIES = [
  { id: "plat-dialogue", label: "\u062D\u0648\u0627\u0631\u0627\u062A \u0627\u0644\u0645\u062F\u0646 \u0648\u0627\u0644\u0637\u0631\u0642", emoji: "\u{1F4AC}", icon: "MessageCircle", color: "text-violet-400" },
  { id: "plat-trainers", label: "\u0627\u0644\u0645\u062F\u0631\u0651\u0628\u0648\u0646 \u0648\u0645\u0628\u0627\u0631\u0632\u0627\u062A\u0647\u0645", emoji: "\u{1F3BD}", icon: "Users", color: "text-rose-400" },
  { id: "plat-battle", label: "\u0627\u0644\u0645\u0639\u0627\u0631\u0643 \u0648\u0627\u0644\u062D\u0631\u0643\u0627\u062A", emoji: "\u2694\uFE0F", icon: "Sword", color: "text-red-400" },
  { id: "plat-species", label: "\u0627\u0644\u0628\u0648\u0643\u064A\u0645\u0648\u0646 \u0648\u0627\u0644\u0628\u0648\u0643\u064A\u062F\u0643\u0633", emoji: "\u{1F43E}", icon: "BookOpen", color: "text-emerald-400" },
  { id: "plat-items", label: "\u0627\u0644\u0623\u062F\u0648\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u064A\u0628\u0629 \u0648\u0627\u0644\u0645\u062A\u0627\u062C\u0631", emoji: "\u{1F392}", icon: "Backpack", color: "text-amber-400" },
  { id: "plat-menus", label: "\u0627\u0644\u0642\u0648\u0627\u0626\u0645 \u0648\u0627\u0644\u0648\u0627\u062C\u0647\u0629", emoji: "\u25A4", icon: "Monitor", color: "text-sky-400" },
  { id: "plat-contest", label: "\u0627\u0644\u0645\u0633\u0627\u0628\u0642\u0627\u062A \u0648\u0627\u0644\u0628\u0648\u0641\u0646", emoji: "\u{1F380}", icon: "Sparkles", color: "text-pink-400" },
  { id: "plat-media", label: "\u0627\u0644\u062A\u0644\u0641\u0627\u0632 \u0648\u0627\u0644\u0628\u0648\u0643\u064A\u062A\u0634", emoji: "\u{1F4FA}", icon: "Clapperboard", color: "text-cyan-400" },
  { id: "plat-online", label: "\u0627\u0644\u0627\u062A\u0635\u0627\u0644 \u0648\u0627\u0644\u062A\u0628\u0627\u062F\u0644", emoji: "\u{1F310}", icon: "Globe", color: "text-teal-400" },
