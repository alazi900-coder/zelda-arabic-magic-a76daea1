...
import { X, Check, AlertTriangle, Lightbulb, Palette, Shield, Layers, User, Swords, Heart, Settings, MessageSquare, HelpCircle, ChevronDown, ChevronUp, Brain, Sparkles } from "lucide-react";
