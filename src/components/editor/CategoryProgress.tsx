...
import type { SteinsGateCategory } from "@/lib/steinsgate/steinsgate-categories";
import {
...
interface CategoryProgressProps {
  ...
  steinsGateCategories?: SteinsGateCategory[];
  isCrashlands?: boolean;
  /** Fixed list keyed off the export's own section names (crashlands-categories.ts). */
  crashlandsCategories?: FileCategory[];
  isNinthDawn?: boolean;
