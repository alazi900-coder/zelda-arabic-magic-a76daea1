...
interface CategoryProgressProps {
  ...
  isInazuma?: boolean;
  /** Fixed list of the cartridge's three text files (see src/lib/inazuma/inazuma-categories.ts). */
  inazumaCategories?: FileCategory[];
  isGoldenSun?: boolean;
  /** Fixed list derived from Golden Sun's string control codes and text shape. */
