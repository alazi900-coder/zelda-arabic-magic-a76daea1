      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-3">
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span className="text-sm font-display font-bold">🔧 ماذا فعلت لم تحل المشكلة لا يزال يفتح ترجماتDragonSword Awakening المحفوظة عندما اريد فتح ترجمات risen 3</span>
          </div>
