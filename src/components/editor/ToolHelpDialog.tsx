...
const toolInfo: Record<Exclude<ToolType, null>, {
  ...
  'auto-correct': {
    ...
    title: '✏️ تصحيح إملائي تلقائي',
    description: 'يفحص جميع الترجمات ويصحح الأخطاء الإملائية والنحوية تلقائياً دفعة واحدة.',
    features: [
      'تصحيح الأخطاء الإملائية الشائعة',
      'إصلاح الهمزات والتاء المربوطة',
      'تصحيح علامات الترقيم العربية',
      'مراجعة قبل تطبيق أي تغيير',
    ],
    example: {
      before: 'انا ذاهب الى المدرسه',
      after: 'أنا ذاهب إلى المدرسة',
    },
  },
  'detect-weak': {
    icon: <AlertTriangle className="w-6 h-6 text-amber-500" />,
    title: '🔍 كشف الترجمات الركيكة',
    description: 'يحلل جودة كل ترجمة ويحدد النصوص الضعيفة تلقائياً مع ترتيبها حسب الأولوية.',
    features: [
      'تقييم كل ترجمة بدرجة من 1-10',
      'كشف الصياغات الحرفية وغير الطبيعية',
      'ترتيب النتائج من الأسوأ للأفضل',
      'اقتراح تحسينات لكل ترجمة ضعيفة',
    ],
    example: {
      before: 'أنا هو الواحد الذي سوف يفعل ذلك (درجة: 3/10)',
      after: 'سأتكفل بالأمر (درجة: 9/10)',
    },
  },
  'context-retranslate': {
    icon: <Brain className="w-6 h-6 text-purple-500" />,
    title: '🧠 إعادة ترجمة ذكية بالسياق',
    description: 'يعيد ترجمة النصوص الضعيفة مع إرسال الجمل المحيطة كسياق للذكاء الاصطناعي.',
    features: [
      'إرسال 5 جمل قبل وبعد كسياق',
      'فهم أفضل لتسلسل الأحداث',
      'الحفاظ على اتساق الأسلوب مع المحيط',
      'مراجعة النتائج قبل التطبيق',
    ],
    example: {
      before: 'ترجمة معزولة بدون سياق → نتيجة غير دقيقة',
      after: 'ترجمة مع 10 جمل محيطة → نتيجة طبيعية ومتسقة',
    },
  },
};
