...
export const TPLE_PROPERTY_INFO: Record<string, TplePropertyInfo> = {
  ...
  Guild: {
    label: "الانتماء/الفصيل",
    description: "الفصيل الاجتماعي/القتالي للشخصية — من فئة gCNPC_PS، نوع بيانات تعدادي (Enum). فحصنا 447 عيّنة حقيقية مجمَّعة حسب مجلدها (Don/Harbour/Monastery/World) لاستنتاج الجدول التالي، وليس ترجمة رسمية: 1=عصابة الدون (مؤكَّدة: تطابق Don_Henchman_L_02_Dead حرفياً، وهي القيمة السائدة في مجلد NPC/Don بأكمله — 34 من 59)، 5=محاكم التفتيش (مؤكَّدة: تطابق كل ملفات Inq_Novice_Fighter وInq_Guard)، 7=قراصنة (مؤكَّدة تماماً: كل الـ4 عيّنات هي حرفياً Pirate_S_01/Pirate_M_01/Pirate_L_01 ولا شيء غيرها)، 0=محايد/بلا فصيل (الأكثر شيوعاً، 102 من 447 — يشمل الوحوش الشبيهة بالبشر كالهياكل العظمية وشخصيات عالمية متفرقة). الأرقام التالية أقل ثقة (استُنتجت من غلبة مجلد/اسم لا تطابق حرفي): 2=بحّارة/عمال ميناء (أسماء مثل Vasili وRomanov في مجلد Harbour)، 3=حرس المدينة (يطابق أغلبية Townsguard_01 إلى 05)، 4=مدنيون عاديون (يطابق أغلبية Townswoman/Townsman وSara/Jasmin)، 6=رهبان الدير (الأكثر شيوعاً في مجلد Monastery بعد محاكم التفتيش). عدّل بحذر — تغيير الانتماء قد يكسر منطق حوار أو عداء مبني على الفصيل.",
    category: "other", system: "الشخصيات (NPC)",
  },
  FightAIMode: {
    label: "نمط الذكاء الاصطناعي القتالي",
    description: "نمط سلوك الذكاء الاصطناعي أثناء القتال — من فئة gCCombatSystem_PS، نوع بيانات تعدادي (Enum). فحصنا **كل** عيّنة حقيقية في الأرشيف بأكمله (462 من 462 — تشمل الشخصيات والوحوش معاً، لا مجلد NPC فقط) ولم نجد قيمة غير 0 إطلاقاً في أي ملف واحد. بمعنى: لا توجد أي عيّنة حقيقية لمقارنتها لاستنتاج معنى أي رقم آخر — تعديله لقيمة غير 0 تجربة بلا أي سابقة في بيانات اللعبة الفعلية، وقد لا يكون لها دعم حقيقي إطلاقاً.",
    category: "other", system: "الشخصيات (NPC)",
  },
  GuardStatus: {
    label: "حالة الحراسة",
    description: "حالة الحراسة/التأهب للشخصية — من فئة gCNPC_PS، نوع بيانات تعدادي (Enum). فحصنا كل عيّنة حقيقية في الأرشيف بأكمله (445 من 445 — شخصيات ووحوش معاً) ولم نجد قيمة غير 0 إطلاقاً في أي ملف واحد. نفس ملاحظة FightAIMode: لا سابقة حقيقية لأي رقم آخر، عدّله بحذر شديد وبلا توقّع نتيجة مضمونة.",
    category: "other", system: "الشخصيات (NPC)",
  },
  AttitudeLock: {
    label: "قفل الموقف",
    description: "هل موقف الشخصية تجاه اللاعب (عدائي/محايد/ودّي) مثبَّت ولا يتغيّر تلقائياً بمنطق اللعبة — من فئة gCNPC_PS، نوع بيانات تعدادي (Enum). القيمة 0 هي الطاغية بشدة (441 من 445 عيّنة حقيقية)؛ القيمة 1 ظهرت في 4 ملفات فقط (Sara.tple، Narrator.tple، Eldric.tple، Dork.tple) بلا سمة مشتركة واضحة تفسّر لماذا هذه الأربعة تحديداً — لذا لا يمكننا الجزم بمعنى القيمة 1 بثقة كافية، فقط أنها نادرة جداً واستثنائية.",
    category: "other", system: "الشخصيات (NPC)",
  },
