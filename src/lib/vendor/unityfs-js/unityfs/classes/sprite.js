...
import { BoneWeights4, SubMesh, VertexData } from './mesh.js'
import { KVPair } from '../basicTypes.js'

export class SecondarySpriteTexture {
    static exposedAttributes = ['texture', 'name']
...
export class SpriteSettings {
    static exposedAttributes = ['packed', 'packingMode', 'packingRotation', 'meshType']
...
export class SpriteVertex {
    static exposedAttributes = ['pos', 'uv']
...
export class Rectf {
    static exposedAttributes = ['x', 'y', 'width', 'height']
