...
const games = [
  ...
  },
  {
    ...
    subtitleClass: "text-[hsl(42,95%,72%)]",
  ...
  {
    title: "Golden Sun",
    subtitle: "عرّب لعبة GBA — النص والخط جاهزان، الاتجاه قيد العمل",
    desc: "يفكّ ١٠,٧٢٢ سطراً مضغوطة بطريقة Huffman من الروم، يترجمها في المحرر، ويعيد بناء الجدول مع الخط العربي فوق خط اللعبة. اتجاه الكتابة من اليمين لليسار لم يُربط بعد — الروم المبني يُعرض من اليسار لليمين حالياً.",
    link: "/golden-sun",
    image: pokemonBg,
    formats: [".gba", "GBA ROM"],
    cardClass: "border-[hsl(35,80%,50%)]/30 hover:border-[hsl(35,80%,50%)]/60",
    formatClass: "bg-[hsl(35,80%,50%)]/20 text-[hsl(35,85%,62%)] border-[hsl(35,80%,50%)]/30",
    subtitleClass: "text-[hsl(35,85%,62%)]",
    arrowClass: "text-[hsl(35,85%,62%)]",
  },
  {
