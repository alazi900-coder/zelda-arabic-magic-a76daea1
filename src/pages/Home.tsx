...
const games = [
  ...
  },
  {
    ...
    desc: "يرفع الروم الإنجليزي Beta 2، ويستخرج كل نصوص الرسائل الإنجليزية من ملفات m/ — حوار القصة ورسائل القوائم ووصفها — إلى المحرر. عند البناء يدمج الخط العربي TTF داخل خانات آمنة ويعرض تقرير حقن مفصلاً قبل أن تجرّب الروم الناتج.",
    link: "/fire-emblem-12",
    image: dragonSwordBg,
