...
const games = [
  ...
  {
    title: "Golden Sun",
    subtitle: "عرّب لعبة الـGBA — خط عربي وكتابة من اليمين",
    desc: "ارفع الروم بعد تطبيق رقعة الخط وعكس الاتجاه عليه: تُفكّ نصوصه الـ١٠,٧٢٢ المضغوطة بطريقة Huffman إلى المحرر، ثم يُكتب النص المترجم في نفس الروم.",
    link: "/golden-sun",
    image: pokemonBg,
    formats: [".gba", "GBA ROM"],
