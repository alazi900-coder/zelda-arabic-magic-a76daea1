  ...
  return (
    <div ref={ref} className="min-h-screen flex flex-col">
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="rounded-2xl border p-8 md:p-12 shadow-lg" style={{ borderColor: `${ACCENT}4d` }}>
            ...
            <h2 className="text-2xl md:text-3xl font-display font-bold mb-4">مدير ملفات Risen 1</h2>
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              افتح أي أرشيف .pak أو .p00/.p01 وما شابه، وتصفّح قائمة ملفاته الداخلية بدون فتح محتواها، واختر ملفاً أو أكثر أو مجلداً كاملاً لتنزيله كملف ZIP
            </p>
            <Link to="/risen/files">
              <Button size="lg" className="font-display font-bold text-xl px-12 py-7 shadow-xl" style={{ backgroundColor: ACCENT, color: "white" }}>
                🗂️ افتح مدير الملفات
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="rounded-2xl border p-8 md:p-12 shadow-lg" style={{ borderColor: `${ACCENT}4d` }}>
            ...
            <h2 className="text-2xl md:text-3xl font-display font-bold mb-4">أداة خطوط Risen 3</h2>
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              افتح <code>0_na_fnt.pak</code>، اختر خطّاً، وأضف إليه الأشكال العربية. أطالس هذه اللعبة حقول مسافة (SDF) لا صوراً، والأداة تولّدها بالترميز نفسه.
            </p>
            <Link to="/risen3/fonts">
              <Button size="lg" className="font-display font-bold text-xl px-12 py-7 shadow-xl" style={{ backgroundColor: ACCENT, color: "white" }}>
                🅰️ افتح أداة خطوط Risen 3
              </Button>
            </Link>
          </div>
        </div>
      ...
      <GameInfoSection
        ...
        method="ارفع ملف strings.p00 أو strings.pak. الأداة تفكّ كل الجداول الداخلية، وتعرض النص الإنجليزي فقط بالمحرر لتترجمه إلى العربية باستخدام الذكاء الاصطناعي والقاموس. عند الانتهاء، ارجع إلى صفحة Risen واضغط 'بناء الملف' لتحميل الملف المُعرَّب."
