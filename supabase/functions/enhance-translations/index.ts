...
const RULES: RuleDef[] = [
  ...
  { id: 'detect_pkm_linebreaks', kind: 'detect', prompt: '**line_breaks** — [خاص ببوكيمون] صندوق الحوار سطران ولا يعيد لفّ النصّ، وعرض السطر **١٩٨ بكسل** — أي نحو ٢٦ إلى ٣٣ حرفاً عربياً، لأن كل حرف يأخذ من ٤ إلى ٨ بكسل والمسافة ٣ (كلّه مقيس في المحاكي). عدد فواصل الأسطر (`\\n`) ومواضعها في الترجمة يجب أن تطابق النصّ الإنجليزي الأصلي، وأي سطر أطول من ذلك يجب أن يُقسم بفاصل `\\n`. ما يخرج عن الصندوق لا يُمسح، فيبقى ظاهراً فوق الرسائل التالية. لا تستعمل أي وسم تقسيم آخر — لا وجود لوسوم في هذه اللعبة غير قيم `{FD:xx}`.' },
