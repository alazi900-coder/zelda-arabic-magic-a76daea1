...
⚠️ **يُسمح بإصدار أكثر من مدخل لنفس index** إذا اكتشفت أكثر من نوع مشكلة (مثلاً: ترتيب + ركاكة + مصطلح خاطئ). أعِد سجلّاً منفصلاً لكلّ مشكلة بفئة category مختلفة. النظام سيدمجها تلقائيّاً في عرض موحَّد للمستخدم.
كلّ سجلّ منفصل يجب أن يكون suggested فيه نصّاً عربيّاً نهائيّاً صحيحاً (ليس جزءاً فقط من الإصلاح).
